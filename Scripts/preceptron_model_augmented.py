...
train_data = pd.read_csv('../data/mfcc_features_augmented_train.csv')
...
joblib.dump(mlp, '../results/models/mlp_model_augmented.pkl')
joblib.dump(scaler, '../results/scalers/mlp_scaler_augmented.pkl')
