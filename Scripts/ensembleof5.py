...
# Load the dataset for prediction (assuming it's a new dataset)
new_data = pd.read_csv('../Data/mfcc_features_train.csv')
...
knn_model = joblib.load('../results/models/knn_model.pkl')
svm_model = joblib.load('../results/models/svm_model.pkl')
random_forest_model = joblib.load('../results/models/random_forest_model.pkl')
xgboost_model = joblib.load('../results/models/xgboost_model.pkl')
mlp_model = joblib.load('../results/models/mlp_model_extended.pkl')

knn_scaler = None  # Assuming no scaler is used for KNN
svm_scaler = joblib.load('../results/scalers/svm_scaler.pkl')  # Scaler used for SVM
xgboost_scaler = None  # Assuming no scaler is used for XGBoost
mlp_scaler = joblib.load('../results/scalers/mlp_scaler.pkl')  # Scaler used for MLP
